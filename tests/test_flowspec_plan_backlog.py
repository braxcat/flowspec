"""Tests for /flow:plan command backlog.md integration.

This test module verifies that the /flow:plan command correctly integrates
...
def plan_command_path():
    ...
    return Path(__file__).parent.parent / ".claude" / "commands" / "flow" / "plan.md"
