...
2. **Workflow engine** - Required for /jpspec command state management
...
| 264 | Migrate jpspec commands to templates |
| 265 | Add jpspec commands to specify init distribution |
...
| 271 | Migrate jpspec commands to templates |
| 272 | Migrate speckit commands to subdirectory |
| 273 | Update dev-setup command for jpspec symlinks |
...
- ❌ Removal of `jpspec_workflow.yml` and schema
